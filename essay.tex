...
\vspace{2em}
\noindent Words: 5891 (Maximum: 5000)
\vspace{5em}
%}
...
%}
\section{Higher-Order Logic}%419/500%{
...
%}
\section{Composable Morphisms and Categories}%1608/1500%{
...
%}
\section{A Category of Classes and of Sets}%1480/1400%{
\label{Set}
...
First, we prove that a class is small only if it is in bijection with the elements of a ZFC set (the definition only required an injection):
\begin{align*}
...
%}
\section{The Yoneda Embedding}%863/600%{
\label{Yoneda}
