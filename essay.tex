...
\vspace{2em}
\noindent Words: 5463 (Maximum: 5000)
\vspace{5em}
%}
...
%}
\section{Composable Morphisms and Categories}%1485/1400%{
...
We use a polymorphic record for categories\footnote{This is just the data; the conditions come later.} as well, abbreviating $(\alpha,\alpha,\beta)\;\mathsf{morphism}$ by $(\alpha,\beta)\;\mathsf{mor}$:
\begin{align*}
...
%}
\section{Two Categories of Sets}%1393/1400%{
\label{Set}
...
%}
\section{Binary Products and Other Limits}%360/250%{
\label{limits}
